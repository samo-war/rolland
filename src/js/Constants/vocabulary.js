export const VOCABULARY = [
    {
        word: 'table',
        translation: ['стол', 'таблица', 'расписание', 'доска']
    },
    {
        word: 'chair',
        translation: ['стул', 'кресло', 'кафедра']
    },
    {
        word: 'lamp',
        translation: ['лампа', 'светильник', 'фонарь']
    },
    {
        word: 'computer',
        translation: ['компьютер', 'ЭВМ', 'ПК']
    },
    {
        word: 'bottle',
        translation: ['бутылка', 'флакон', 'бутыль']
    },
    {
        word: 'woman',
